    ...
    substitutes: [
      {
        ...
        reason: "Removes forefoot impact and calf/ankle tendon cyclic load while preserving cardiovascular and hip/knee work",
        substituteSpares: ["Ankle L", "Ankle R", "Calf L", "Calf R"],
      },
      {
        id: "swim_freestyle",
        name: "Swimming (Freestyle, No Backstroke)",
        reason: "Removes all lower-limb load; zero MTP, ankle, and knee stress",
        substituteSpares: ["Toe L", "Ankle L", "Ankle R", "Calf L", "Calf R", "Knee L", "Knee R", "Hip L", "Hip R"],
      },
    ],
    mtp_safe: false,
    ...
    substitutes: [
      {
        id: "swim_freestyle",
        name: "Swimming (Freestyle, No Backstroke)",
        reason: "Removes all lower-body load; preferred when both knee and Toe L OC are active",
        substituteSpares: ["Knee L", "Knee R", "Quad L", "Quad R", "Calf L", "Calf R", "Toe L"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "cycling_stationary",
        name: "Cycling (Stationary / Spin)",
        reason: "Removes shoulder and elbow tendon load; preserves aerobic conditioning",
        substituteSpares: ["Shoulder L", "Shoulder R", "Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        ...
        reason: "Same chest drive pattern on Smith; use when machine is unavailable",
        substituteSpares: [],
      },
      {
        id: "cable_crossover",
        name: "Cable Crossover (Chest Volume)",
        reason: "Reduces shoulder and elbow tendon demand to score 1 while maintaining chest activation",
        substituteSpares: ["Shoulder L", "Shoulder R", "Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "cable_crossover",
        name: "Cable Crossover (Chest Volume)",
        reason: "Reduces shoulder and elbow tendon demand while maintaining chest volume",
        substituteSpares: ["Shoulder L", "Shoulder R", "Elbow L", "Elbow R"],
      },
      {
        id: "machine_flys",
        name: "Machine Flys / Cable Flys",
        reason: "Removes elbow extension demand; pec isolation under eccentric stretch",
        substituteSpares: ["Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "cable_crossover",
        name: "Cable Crossover (Chest Volume)",
        reason: "Lowers shoulder tendon demand from 2 to 1; maintains pec stimulation",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        ...
        reason: "Reduces supraspinatus load from 3 to 2; shifts emphasis to posterior cuff",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
      {
        id: "face_pull_er",
        name: "Face Pull / External Rotation",
        reason: "Reduces shoulder tendon load from 3 to 2; maintains rotator cuff health work",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "face_pull_er",
        name: "Face Pull / External Rotation",
        reason: "Same posterior cuff focus; loaded ER adds rotational stability stimulus",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        ...
        reason: "Alternate triceps stimulus with long-head eccentric stretch",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "triceps_pulldown",
        name: "Triceps Pulldown / Pushdown (Cable)",
        reason: "Removes overhead shoulder position; lateral head emphasis with no shoulder tendon load",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "plank",
        name: "Plank (3 × 60 sec)",
        reason: "Removes active shoulder and elbow load; anti-extension isometric only",
        substituteSpares: ["Shoulder L", "Shoulder R", "Elbow L", "Elbow R"],
      },
      {
        id: "deadbugs",
        name: "90/90 Deadbugs",
        reason: "Supine position removes all shoulder and elbow load; anti-extension with hip flexor",
        substituteSpares: ["Shoulder L", "Shoulder R", "Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "plank",
        name: "Plank (3 × 60 sec)",
        reason: "Same anti-rotation intent; no cable required",
        substituteSpares: [],
      },
      {
        id: "suitcase_carry",
        name: "Suitcase Carry",
        reason: "Adds functional gait challenge while preserving anti-lateral-flexion demand",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        ...
        reason: "Same glute pattern at lower load; maintains stimulus when reducing heavy sets",
        substituteSpares: [],
      },
      {
        id: "hip_abduction",
    ...
    substitutes: [
      {
        id: "cycling_stationary",
        name: "Cycling (Stationary / Spin)",
        reason: "Removes forefoot, ankle, and glute loading; preserves quad and knee cyclic stimulus",
        substituteSpares: ["Toe L", "Ankle L", "Glute L", "Glute R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        ...
        reason: "Same hamstring eccentric pattern; use DB or barbell when KB unavailable",
        substituteSpares: [],
      },
      {
        id: "hamstring_eccentric_curl",
        name: "Hamstring Eccentric Curl (Leg Curl, 4s Eccentric)",
        reason: "Machine isolation removes lower back and glute demand; isolates hamstring eccentrically",
        substituteSpares: ["Lower Back", "Glute L", "Glute R", "Ankle L"],
      },
    ],
    mtp_safe: true,
  ...
  },
  {
    ...
    substitutes: [
      ...
      },
      {
        ...
        reason: "Stationary version reduces Toe L load from 2 to 1",
    ...
    substitutes: [
      {
        ...
        reason: "Small-ROM band isometric; maintains patellar tendon stimulus at reduced quad demand",
        substituteSpares: ["Quad L", "Quad R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "deadbugs",
        name: "90/90 Deadbugs",
        reason: "Supine position removes shoulder stabilization demand",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
      {
        id: "pallof_press",
        name: "Pallof Press (Cable, Split Stance)",
        reason: "Removes lower back isometric compression; standing anti-rotation",
        substituteSpares: ["Lower Back"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "plank",
        name: "Plank (3 × 60 sec)",
        reason: "Prone anti-extension; removes hip flexor demand",
        substituteSpares: ["Hip L", "Hip R"],
      },
      {
        id: "pallof_press",
        name: "Pallof Press (Cable, Split Stance)",
        reason: "Removes hip flexor and lower back demand; standing anti-rotation core",
        substituteSpares: ["Hip L", "Hip R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "inverted_row",
        name: "Inverted Row",
        reason: "Bodyweight pull removes lower back rotational load; reduces shoulder demand to score 1",
        substituteSpares: ["Lower Back", "Shoulder L", "Shoulder R"],
      },
      {
        id: "lat_pulldown",
        name: "Lat Pulldown",
        reason: "Removes lower back load; reduces shoulder demand to score 1",
        substituteSpares: ["Lower Back", "Shoulder L", "Shoulder R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "cable_row_single_arm",
        name: "Cable Row (mid) — Single Arm",
        reason: "Seated horizontal pull; different plane but maintains upper back and elbow flexor stimulus",
        substituteSpares: [],
      },
      {
        id: "inverted_row",
        name: "Inverted Row",
        reason: "Bodyweight option; maintains upper back and elbow flexor load",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "lat_pulldown",
        name: "Lat Pulldown",
        reason: "Adds elbow flexor involvement; maintains lat and upper back stimulus",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "lat_pulldown",
        name: "Lat Pulldown",
        reason: "Machine-assisted seated pull; removes core anti-sag demand",
        substituteSpares: ["Core/Abs"],
      },
      {
        id: "straight_arm_pulldown",
        name: "Straight Arm Pulldowns",
        reason: "Removes core and elbow flexor load; pure lat isolation",
        substituteSpares: ["Core/Abs", "Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "hammer_curl",
        name: "Hammer Curl",
        reason: "Neutral grip reduces supination stress on elbow; brachioradialis emphasis",
        substituteSpares: [],
      },
      {
        id: "cable_d2_flexion",
        name: "Cable D2 Flexion",
        reason: "Diagonal pattern removes forearm extensor load while maintaining elbow flexor work",
        substituteSpares: ["Forearm L", "Forearm R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "hammer_curl",
        name: "Hammer Curl",
        reason: "Removes shoulder demand; focuses load on elbow flexors only",
        substituteSpares: ["Shoulder L", "Shoulder R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "hammer_curl",
        name: "Hammer Curl",
        reason: "DB neutral-grip variant; maintains brachialis focus at similar elbow load",
        substituteSpares: [],
      },
      {
        id: "straight_arm_pulldown",
        name: "Straight Arm Pulldowns",
        reason: "Removes elbow flexion entirely; lat/teres minor substitute that spares elbow tendons",
        substituteSpares: ["Elbow L", "Elbow R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "cable_d2_flexion",
        name: "Cable D2 Flexion",
        reason: "Diagonal pattern removes forearm extensor demand",
        substituteSpares: ["Forearm L", "Forearm R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "pallof_press",
        name: "Pallof Press (Cable, Split Stance)",
        reason: "Removes lower back lateral load and forefoot contact; stationary cable anti-rotation",
        substituteSpares: ["Lower Back", "Toe L"],
      },
      {
        id: "plank",
        name: "Plank (3 × 60 sec)",
        reason: "Removes forefoot contact; prone anti-extension with lower back demand",
        substituteSpares: ["Toe L"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "machine_flys",
        name: "Machine Flys / Cable Flys",
        reason: "Pec isolation under eccentric stretch when cables unavailable",
        substituteSpares: [],
      },
      {
        id: "chest_press_machine",
        name: "Chest Press (Machine / Technogym)",
        reason: "Same chest focus with pressing pattern; use when cable station occupied",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "hip_drive_marches",
        name: "Hip Drive Marches (Band)",
        reason: "Standing version adds core and gait stimulus to hip abductor load",
        substituteSpares: ["IT Band L", "IT Band R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "hip_thrust_volume",
        name: "Hip Thrust (Smith Machine, Volume)",
        reason: "Removes hip hinge back load and forefoot drive; supported glute emphasis",
        substituteSpares: ["Lower Back", "Toe L", "Ankle L", "Knee L"],
      },
      {
        id: "romanian_deadlift",
        name: "Romanian Deadlift (DB / Barbell)",
        reason: "Same hip hinge pattern without ballistic component; removes forefoot and knee load",
        substituteSpares: ["Toe L", "Ankle L", "Knee L"],
      },
    ],
    mtp_safe: false,
  ...
  },
  {
    ...
    substitutes: [
      ...
      },
      {
        id: "hip_adduction",
        name: "Hip Adduction (Machine)",
        reason: "Seated machine; shifts from glute extension to hip adductor patterning; removes hamstring and foot load",
    ...
    substitutes: [
      {
        id: "kb_rdl",
        name: "KB RDL / Trap Bar Deadlift",
        reason: "Same eccentric hamstring pattern with KB; use when barbell unavailable",
        substituteSpares: [],
      },
      {
        id: "hamstring_eccentric_curl",
        name: "Hamstring Eccentric Curl (Leg Curl, 4s Eccentric)",
        reason: "Machine isolation removes lower back and glute demand; pure hamstring eccentric",
        substituteSpares: ["Lower Back", "Glute L", "Glute R"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "kb_rdl",
        name: "KB RDL / Trap Bar Deadlift",
        reason: "Hip hinge variant; removes knee and ankle tendon load",
        substituteSpares: ["Knee L", "Knee R", "Ankle L"],
      },
      {
        id: "romanian_deadlift",
        name: "Romanian Deadlift (DB / Barbell)",
        reason: "Same posterior chain pattern; removes knee and ankle tendon involvement",
        substituteSpares: ["Knee L", "Knee R", "Ankle L"],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "face_pull_er",
        name: "Face Pull / External Rotation",
        reason: "Cable ER; same rotator cuff maintenance intent with added pulling component",
        substituteSpares: [],
      },
    ],
    mtp_safe: true,
    ...
    substitutes: [
      {
        id: "plank",
        name: "Plank (3 × 60 sec)",
        reason: "Removes rotational lumbar demand; anti-extension isometric",
        substituteSpares: [],
      },
      {
        id: "pallof_press",
        name: "Pallof Press (Cable, Split Stance)",
        reason: "Removes lower back rotational stress; standing anti-rotation core",
        substituteSpares: ["Lower Back"],
      },
    ],
    mtp_safe: true,
  ...
  for (const ex of dayExercises) {
    ...
    for (const ocItem of activeOcItems) {
      ...
      flags.push({
        ...
        severity,
        substitutes: entry.substitutes.map(sub => sub.name).filter(Boolean),
        substituteIds: entry.substitutes.map(sub => sub.id),
      })
    }
  }
